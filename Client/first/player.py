...
class PLAYER:
    def __init__(self, _id, _posX, _posY, _name):                                            # Initialize the player with an ID, position, and alive status
    ...
    def draw(self, screen, cellSize):                                                         # Draw the player on the screen as a rectangle
    ...
    def move(self):                                                                           # Update the player's position based on the current direction
