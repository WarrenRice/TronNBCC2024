...
class MAP:
    def __init__(self, size):                                                                    # Initialize the map with the specified size and set all cells to 0
    ...
    def setValue(self, x, y, value):                                                             # Set the value of a cell in the map at the specified (x, y) coordinates
    ...
    def getValue(self, x, y):                                                                      # Get the value of a cell in the map at the specified (x, y) coordinates
    ...
    def printMap(self):                                                                            # Print the map to the console (for debugging or text-based output)
    ...
    def drawMap(self, screen, cellSize):                                                           # Draw the map onto the given Pygame screen with each cell of the specified cellSize
        ...
        for row in range(self.size):
            for col in range(self.size):
                ...
                pygame.draw.rect(screen, self.use_color[self.map[col][row]], bodyRect)             # Draw the rectangle for the map cell
